...
ReadyLabel2a=Нажмите «Установить», чтобы продолжить, или «Назад», если вы хотите просмотреть или изменить параметры установки.
...
VerificationFileHashIncorrect=Неверный хеш файла
ExistingFileReadOnly2=Невозможно заменить существующий файл, так как он помечен как «только для чтения».
...
ErrorRestartReplace=Ошибка перезапуска и замены:
