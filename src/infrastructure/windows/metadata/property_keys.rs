...
// System.Audio.SampleRate (64440490-4C8B-11D1-8B70-080036B11A03, 5)
pub const PKEY_AUDIO_SAMPLERATE: PROPERTYKEY = PROPERTYKEY {
    fmtid: GUID::from_u128(0x64440490_4C8B_11D1_8B70_080036B11A03),
    pid: 5,
};

// System.Music.Artist (56A3372E-CE9C-11D2-9F0E-006097C686F6, 2)
pub const PKEY_MUSIC_ARTIST: PROPERTYKEY = PROPERTYKEY {
    fmtid: GUID::from_u128(0x56A3372E_CE9C_11D2_9F0E_006097C686F6),
    pid: 2,
};

// System.Music.AlbumTitle (56A3372E-CE9C-11D2-9F0E-006097C686F6, 4)
pub const PKEY_MUSIC_ALBUMTITLE: PROPERTYKEY = PROPERTYKEY {
    fmtid: GUID::from_u128(0x56A3372E_CE9C_11D2_9F0E_006097C686F6),
    pid: 4,
};
...
pub const PKEY_MUSIC_GENRE: PROPERTYKEY = PROPERTYKEY {
    fmtid: GUID::from_u128(0x56A3372E_CE9C_11D2_9F0E_006097C686F6),
    pid: 11,
};

// System.Media.Year (56A3372E-CE9C-11D2-9F0E-006097C686F6, 5)
pub const PKEY_MEDIA_YEAR: PROPERTYKEY = PROPERTYKEY {
    fmtid: GUID::from_u128(0x56A3372E_CE9C_11D2_9F0E_006097C686F6),
    pid: 5,
};
