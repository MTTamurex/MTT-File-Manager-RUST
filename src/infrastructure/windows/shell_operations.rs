...
pub use shfile_ops::{
    copy_item_with_shell, copy_items_with_shell, delete_item_with_shell, delete_items_with_shell,
    move_item_with_shell, move_items_with_shell, rename_item_with_shell,
};
