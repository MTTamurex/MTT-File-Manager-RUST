...
pub struct ImageViewerApp {
    ...
    pub live_file_size_cache: crate::app::live_file_size::LiveFileSizeCache,
    pub live_file_size_loading: crate::app::live_file_size::ActiveLiveFileSizeRequests,
    ...
    /// list view render. Set after folder navigation and when dual panel is
    /// disabled so widths match the available content and panel size.
    ...
    pub(crate) pending_tag_view_hides:
        rustc_hash::FxHashMap<usize, std::collections::VecDeque<PathBuf>>,
