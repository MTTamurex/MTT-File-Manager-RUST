...
impl ImageViewerApp {
    pub fn new(cc: &eframe::CreationContext<'_>) -> Self {
        ...
        crate::ui::theme::apply_theme_visuals(&ctx, theme_mode);
        ...
        let (video_player_close_sender, video_player_close_receiver) = std::sync::mpsc::channel();
        ...
        let mut app = Self {
            ...
            inactive_items_rebuild_sender,
            inactive_items_rebuild_receiver,
            deferred_inactive_items_rebuild_results: std::collections::VecDeque::new(),
            inactive_items_rebuild_registry: Arc::new(Default::default()),
            // Cover Worker
            ...
            pending_folder_cover_removals: std::collections::BTreeMap::new(),
            ...
            theme_mode,
            system_theme_dark: theme_mode.resolve_dark(),
