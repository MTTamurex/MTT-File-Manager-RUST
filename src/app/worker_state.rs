...
impl WorkerState {
    pub fn new() -> Self {
        ...
        let (folder_preview_sender, _folder_preview_to_worker) = std::sync::mpsc::channel::<PathBuf>();
        let (_folder_preview_from_worker, folder_preview_receiver) = std::sync::mpsc::channel::<FolderPreviewData>();
