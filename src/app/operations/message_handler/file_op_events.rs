...
impl ImageViewerApp {
                ...
                Some(res) => {
                    ...
                    match res {
                        ...
                        FileOperationResult::CompressionCompleted {
                            ...
                            self.handle_compression_completed(
                                dest_folder,
                                archive_path,
                                current_path_norm,
                            );
    ...
    fn handle_compression_completed(
        &mut self,
        dest_folder: PathBuf,
        ...
        // The archive was fully written and renamed into place by the worker —
        // it is safe to read for thumbnails immediately.
        crate::infrastructure::windows::file_flags::clear_write_activity_after_completed_file_operation(
        ...
        // Suppress watcher-triggered reloads for 2 seconds to avoid redundant
        // reloads from filesystem events generated by the archive write.
        self.watcher_cooldown_until = Some(Instant::now() + Duration::from_secs(2));
